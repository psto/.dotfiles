return {
  ...
  keys = {
    ...
    { "<leader>fQ",  "<cmd>Telescope quickfix_stack<cr>",                                                                                                    desc = "Quickfix History" },
    ...
    { "<leader>gc",  '<cmd>lua require"telescope.builtin".git_commits{git_command = { "git", "log", "--all", "--pretty=oneline", "--abbrev-commit" } }<cr>', desc = "Checkout commit" },
    { "<leader>gd",  '<cmd>lua require("util/functions").diffview_toggle("DiffviewOpen")<CR>',                                                               desc = "DiffViewToggle" },
    ...
    { "<leader>gi",  "<cmd>:DiffviewFileHistory<CR><C-w>w<C-w>|<cr>",                                                                                        desc = "Line History" },
    ...
    { "<leader>lb",  "<cmd>Trouble diagnostics toggle focus=false filter.buf=0<cr>",                                                                         desc = "Buffer Diagnostics" },
    ...
    { "<leader>lx",  "<cmd>Trouble qflist toggle<cr>",                                                                                                       desc = "Trouble quickfix" },
    { "<leader>lz",  "<cmd>Trouble loclist toggle<cr>",                                                                                                      desc = "Trouble loclist" },
    ...
    { "<leader>st",  "<cmd>lua _TASKWARRIOR_TOGGLE()<CR>",                                                                                                   desc = "Taskwarrior" },
